...
//----------------------------------
  ...
  **/
  ...
  ERQTelescopeGeoNonUniformSingleSi* thin1 = new ERQTelescopeGeoNonUniformSingleSi("SingleSi", "SingleSi_SSD20",
                                                                                   TVector3(0.22, -0.27, -1.5), TVector3(), "X",
                                                                                   "./input/map1.root"); 
  ERQTelescopeGeoComponentSingleSi* thin1_1 = new ERQTelescopeGeoComponentSingleSi("SingleSi", "SingleSi_SSD20_1",
  ...
  ERQTelescopeGeoNonUniformSingleSi* thin2 = new ERQTelescopeGeoNonUniformSingleSi("SingleSi", "SingleSi_SSD20",
                                                                                   TVector3(0.27, 0.22, -1.5), TVector3(), "Y",
                                                                                   "./input/map2.root");
  ERQTelescopeGeoComponentSingleSi* thin2_2 = new ERQTelescopeGeoComponentSingleSi("SingleSi", "SingleSi_SSD20_2",
                                                                                   TVector3(0.22, -0.27, -0.5), TVector3(), "X");    
  ERQTelescopeGeoComponentDoubleSi* thick2 = new ERQTelescopeGeoComponentDoubleSi("DoubleSi", "DoubleSi_DSD1", 
  ...
  ERQTelescopeGeoNonUniformSingleSi* thin3 = new ERQTelescopeGeoNonUniformSingleSi("SingleSi", "SingleSi_SSD20",
                                                                                   TVector3(-0.22, 0.27, -1.5), TVector3(), "X",
                                                                                   "./input/map3.root"); 
  ERQTelescopeGeoComponentSingleSi* thin3_3 = new ERQTelescopeGeoComponentSingleSi("SingleSi", "SingleSi_SSD20_3",
                                                                                   TVector3(-0.22, 0.27, -0.5), TVector3(), "Y");   
  ERQTelescopeGeoComponentDoubleSi* thick3 = new ERQTelescopeGeoComponentDoubleSi("DoubleSi", "DoubleSi_DSD1", 
                                                                                  TVector3(0., 0., 1.), TVector3(), "X");
  ...
  ERQTelescopeGeoNonUniformSingleSi* thin4 = new ERQTelescopeGeoNonUniformSingleSi("SingleSi", "SingleSi_SSD20",
                                                                                   TVector3(-0.27, -0.22, -1.5), TVector3(), "Y",
                                                                                   "./input/map4.root"); 
  ERQTelescopeGeoComponentSingleSi* thin4_4 = new ERQTelescopeGeoComponentSingleSi("SingleSi", "SingleSi_SSD20_4",
                                                                                   TVector3(-0.27, -0.22, -0.5), TVector3(), "X");   
  ERQTelescopeGeoComponentDoubleSi* thick4 = new ERQTelescopeGeoComponentDoubleSi("DoubleSi", "DoubleSi_DSD1", 
                                                                                  TVector3(0., 0., 1.), TVector3(), "Y");
