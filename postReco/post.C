...
void post(TString inFileReco,TString inFileCleaned,TString outFile) {
  ...
  // digi
  chReco->SetBranchAddress("TelescopePoint_Telescope_1_SingleSi_SSD20_1_X",&v_SSD20_1);
  chReco->SetBranchAddress("TelescopePoint_Telescope_1_SingleSi_SSD50_1_Y",&v_SSD_1);
