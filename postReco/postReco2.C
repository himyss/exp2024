...
void postReco2() {
  ...
  TString inFileReco = "/mnt/data/exp2024/reco/reco2.root";
  TChain *chReco = new TChain("er");
  chReco->Add(inFileReco.Data());
  cout << chReco->GetEntries() << endl;

  TString inFileCleaned = "/mnt/data/exp2024/sim/sim_digi2.root";
  ...
  TString outFile = "/mnt/data/exp2024/postReco/data2.root";
